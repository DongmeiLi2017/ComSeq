...
previous literature. For group label, the {\tt Combined_method} function needs a vector, i.e., "1" denotes the treatment group and "0" 
...
label <- colData(RNAcount)$Treatment  
